    ...
    ko: {
        translation: {
            ...
            chat: {
                ...
                congratulate: "축하하기",
                birthday: "🎂 {{day}}은 {{name}}님의 생일입니다!",
                birthdayMessage: "🎂 {{day}}은 {{name}}님의 생일입니다! 🎉",
                notice: "📢 [공지] {{title}}",
                stop: "중단",
    ...
    en: {
        translation: {
            ...
            chat: {
                ...
                birthday: "🎂 {{day}} is {{name}}'s birthday!",
                birthdayMessage: "🎂 {{day}} is {{name}}'s birthday! 🎉",
                notice: "📢 [Notice] {{title}}",
                stop: "Stop",
    ...
    ja: {
        translation: {
            ...
            chat: {
                ...
                generating: "回答を生成中...",
                congratulate: "お祝いする",
                birthday: "🎂 {{day}}は{{name}}さんの誕生日です！",
                birthdayMessage: "🎂 {{day}}は{{name}}さんの誕生日です！ 🎉",
                notice: "📢 [お知らせ] {{title}}",
                stop: "중단",
    ...
    vi: {
        translation: {
            ...
            chat: {
                ...
                birthday: "🎂 {{day}} là sinh nhật của {{name}}!",
                birthdayMessage: "🎂 {{day}} là sinh nhật của {{name}}! 🎉",
